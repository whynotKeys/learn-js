...
// 시작 시각
const startTime = inputData[0].split(" ");
const startHour = Number(startTime[0]);
const startMinute = Number(startTime[1]);

// 요리 시간
const cookTime = Number(inputData[1]);
const cookMinute = cookTime % 60;
const cookHour = parseInt(cookTime / 60);

// console.log(startHour, startMinute);
// console.log(cookTime, cookHour, cookMinute);

// 종료 시각
let endHour = startHour + cookHour;
let endMinute = startMinute + cookMinute;
